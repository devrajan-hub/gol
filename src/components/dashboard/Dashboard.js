            ...
            <div className="row">
                ...
                <div className="col-md-10">
                    <div className="dashboard-content">
                        <div className="col-md-12 dashboard-heading">
                        <div className="row">
                            ...
                            <div className="col-md-2 pd-right0">
                                <select class="form-select selectpicker" aria-label="Default select example">
                                    ...
                                    <option value="3">Remy Martin</option>
                                </select>
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">VIDS Gallery</a>
                            </li>
                            <li class="nav-item">
